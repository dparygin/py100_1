...
# * Написать логическое выражение для расчета суммы выплаты по депозиту на вклад : до 5000
# грн начисляется 20% годовых, от 5000 грн до 10000 грн - 22% годовых.
sd = int(input("Внесите сумму депозитов на вклад(в грн.): "))

if (sd >= 1) and (sd < 5000):
    sum_dep = sd * 0.2
    print("Сумма годовой выплаты по депозиту составит: ", sum_dep, "грн.,")
elif (sd >= 5000) and (sd < 10000):
    sum_dep = (sd * 0.22)
    print("Сумма годовой выплаты по депозиту составит: ", sum_dep, "грн.,")
else:
    print("У гривнвы не принимаем!")



# * Написать программу для определения времени суток по данному текущему времени и вывести
...
if (hour >= 6) and (hour < 12):
    ...
    print("У Вас компьютер сломался!")



# * Ввести с клавиатуры номер месяца. Определить сезон в зависимости от номера месяца и вывести
# сообщение (весна (3,4,5), лето (6,7,8), осень (9,10,11) зима (12,1,2)).
from time import gmtime, strftime
mon = str(strftime("%m", gmtime()))

if (mon == 12) or (mon == '01') or (mon == '02'):
    print("Сейчас зима!")
...
speed = [int(x) for x in str(speed)]

if (speed >= 1) and (speed < 4):
    print("Слабый ветер!")
elif (speed >= 5) and (speed < 10):
    print("Сейчас умеренный ветер!")
elif (speed >= 9) and (speed < 18):
    print("Сильный ветер!")
elif (hour >= 19):
    print("Это ураган!")
else:
    print("Данные значения не обрабатываются!!")
...
if n[0] == n[1] == n[2]:
    print("Одинаковые все")
elif (n[0] == n[1]) or (n[1] == n[2]) or (n[0] == n[2]):
    print("Есть совпвдающие числа")
else:
    print("Увы, совпадений нет")
...
r = input("Введите число для проверки: ")
rl = [int(xc) for xc in str(r)]
if len(rl) == 6:
    if (rl[0] + rl[1] + rl[2]) == (rl[-3] + rl[-2] + rl[-1]):
        print("Число счастливое!")
    else:
        print("Обычное число")
else:
    print("Это не 6 знаков!")
